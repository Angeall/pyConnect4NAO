...
class DefaultConnect4Model(object):
    ...
    NUMBER_OF_UPPER_HOLES = 28

    def __init__(self, disc=0.056, length=0.519, width=0.066, height=0.337,
                 hole_length=0.0585, hole_width=0.0095, hole_h_space=0.0095, hole_v_margin=0.004, hole_h_margin=0.0275,
                 circle=0.046, circle_h_space=0.02183, circle_v_space=0.009, circle_h_margin=0.033,
                 circle_v_margin=0.008):
