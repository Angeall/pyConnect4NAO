...
class Connect4(object):
    ...
    FRONT_HOLE_0_0 = 35 + NUMBER_OF_CORNERS
    FRONT_HOLE_0_1 = 28 + NUMBER_OF_CORNERS
    FRONT_HOLE_0_2 = 21 + NUMBER_OF_CORNERS
    FRONT_HOLE_0_3 = 14 + NUMBER_OF_CORNERS
    FRONT_HOLE_0_4 = 7 + NUMBER_OF_CORNERS
    FRONT_HOLE_0_5 = 0 + NUMBER_OF_CORNERS
    FRONT_HOLE_1_0 = 36 + NUMBER_OF_CORNERS
    FRONT_HOLE_1_1 = 29 + NUMBER_OF_CORNERS
    FRONT_HOLE_1_2 = 22 + NUMBER_OF_CORNERS
    FRONT_HOLE_1_3 = 15 + NUMBER_OF_CORNERS
    FRONT_HOLE_1_4 = 8 + NUMBER_OF_CORNERS
    FRONT_HOLE_1_5 = 1 + NUMBER_OF_CORNERS
    FRONT_HOLE_2_0 = 37 + NUMBER_OF_CORNERS
    FRONT_HOLE_2_1 = 30 + NUMBER_OF_CORNERS
    FRONT_HOLE_2_2 = 23 + NUMBER_OF_CORNERS
    FRONT_HOLE_2_3 = 16 + NUMBER_OF_CORNERS
    FRONT_HOLE_2_4 = 9 + NUMBER_OF_CORNERS
    FRONT_HOLE_2_5 = 2 + NUMBER_OF_CORNERS
    FRONT_HOLE_3_0 = 38 + NUMBER_OF_CORNERS
    FRONT_HOLE_3_1 = 31 + NUMBER_OF_CORNERS
    FRONT_HOLE_3_2 = 24 + NUMBER_OF_CORNERS
    FRONT_HOLE_3_3 = 17 + NUMBER_OF_CORNERS
    FRONT_HOLE_3_4 = 10 + NUMBER_OF_CORNERS
    FRONT_HOLE_3_5 = 3 + NUMBER_OF_CORNERS
    FRONT_HOLE_4_0 = 39 + NUMBER_OF_CORNERS
    FRONT_HOLE_4_1 = 32 + NUMBER_OF_CORNERS
    FRONT_HOLE_4_2 = 25 + NUMBER_OF_CORNERS
    FRONT_HOLE_4_3 = 18 + NUMBER_OF_CORNERS
    FRONT_HOLE_4_4 = 11 + NUMBER_OF_CORNERS
    FRONT_HOLE_4_5 = 4 + NUMBER_OF_CORNERS
    FRONT_HOLE_5_0 = 40 + NUMBER_OF_CORNERS
    FRONT_HOLE_5_1 = 33 + NUMBER_OF_CORNERS
    FRONT_HOLE_5_2 = 26 + NUMBER_OF_CORNERS
    FRONT_HOLE_5_3 = 19 + NUMBER_OF_CORNERS
    FRONT_HOLE_5_4 = 12 + NUMBER_OF_CORNERS
    FRONT_HOLE_5_5 = 5 + NUMBER_OF_CORNERS
    FRONT_HOLE_6_0 = 41 + NUMBER_OF_CORNERS
    FRONT_HOLE_6_1 = 34 + NUMBER_OF_CORNERS
    FRONT_HOLE_6_2 = 27 + NUMBER_OF_CORNERS
    FRONT_HOLE_6_3 = 20 + NUMBER_OF_CORNERS
    FRONT_HOLE_6_4 = 13 + NUMBER_OF_CORNERS
    FRONT_HOLE_6_5 = 6 + NUMBER_OF_CORNERS
    NUMBER_OF_FRONT_HOLES = 42

    # MODEL INDICES : UPPER HOLES (Left to right)
    UPPER_HOLE_0_TOP_LEFT = 0 + NUMBER_OF_CORNERS + NUMBER_OF_FRONT_HOLES
    UPPER_HOLE_0_BOTTOM_RIGHT = 1 + NUMBER_OF_CORNERS + NUMBER_OF_FRONT_HOLES
    UPPER_HOLE_1_TOP_LEFT = 2 + NUMBER_OF_CORNERS + NUMBER_OF_FRONT_HOLES
    UPPER_HOLE_1_BOTTOM_RIGHT = 3 + NUMBER_OF_CORNERS + NUMBER_OF_FRONT_HOLES
    UPPER_HOLE_2_TOP_LEFT = 4 + NUMBER_OF_CORNERS + NUMBER_OF_FRONT_HOLES
    UPPER_HOLE_2_BOTTOM_RIGHT = 5 + NUMBER_OF_CORNERS + NUMBER_OF_FRONT_HOLES
    UPPER_HOLE_3_TOP_LEFT = 6 + NUMBER_OF_CORNERS + NUMBER_OF_FRONT_HOLES
    UPPER_HOLE_3_BOTTOM_RIGHT = 7 + NUMBER_OF_CORNERS + NUMBER_OF_FRONT_HOLES
    UPPER_HOLE_4_TOP_LEFT = 8 + NUMBER_OF_CORNERS + NUMBER_OF_FRONT_HOLES
    UPPER_HOLE_4_BOTTOM_RIGHT = 9 + NUMBER_OF_CORNERS + NUMBER_OF_FRONT_HOLES
    UPPER_HOLE_5_TOP_LEFT = 10 + NUMBER_OF_CORNERS + NUMBER_OF_FRONT_HOLES
    UPPER_HOLE_5_BOTTOM_RIGHT = 11 + NUMBER_OF_CORNERS + NUMBER_OF_FRONT_HOLES
    UPPER_HOLE_6_TOP_LEFT = 12 + NUMBER_OF_CORNERS + NUMBER_OF_FRONT_HOLES
    UPPER_HOLE_6_BOTTOM_RIGHT = 13 + NUMBER_OF_CORNERS + NUMBER_OF_FRONT_HOLES
    ...
    def generate3DModel(self):
        ...
        for i in range(self.NUMBER_OF_UPPER_HOLES):
        ...
        model = []
        model.extend(corners)
        model.extend(front_holes)
        model.extend(upper_holes)
        return model
